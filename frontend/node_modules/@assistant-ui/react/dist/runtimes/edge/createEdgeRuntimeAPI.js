...
var import_assistantEncoderStream = require("./streams/assistantEncoderStream.cjs");
var import_EdgeRuntimeRequestOptions = require("./EdgeRuntimeRequestOptions.cjs");
var import_toLanguageModelMessages = require("./converters/toLanguageModelMessages.cjs");
...
var import_streamPartEncoderStream = require("./streams/utils/streamPartEncoderStream.cjs");
var voidStream = () => {
        ...
        new TransformStream({
          ...
          flush() {
            ...
            const resultingMessages = [
              ...messages,
              (0, import_toCoreMessages.toCoreMessage)({
                role: "assistant",
